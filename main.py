...
from parameter_estimation import (
    compute_marginal_priors,
    create_pseudo_counts,
    fit_model_with_priors,
)
...
def main():
    ...
    yearly_models, final_pseudo_counts = update_temporal_model(
        df, model.edges(), years, alpha0, pseudo_counts
    )
